...
Hlavním cílem návrhu byla znovupou¾itelnost\cite{Stroustrup}\cite{Gamma}\cite{Sutter}\cite{Pecin}. Vìt¹ina modulù nemá ¾ádné externí závislosti. Pokud bychom napø. místo knihovny \texttt{GAlib} chtìli pou¾ít jinou knihovnu, staèilo by nadefinovat dvì nové tøídy pracující se stávajícím objektovým modelem. Program je z hlediska návrhu dìlen do nìkolika èástí:
\begin{itemize}
